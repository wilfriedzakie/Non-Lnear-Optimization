function[r,x,y]= David_fletcher_Him(epsilon,r0,t0,MyGrad,Myfunc)
teta=[1 0;0 1];
k=1;
r=r0;
x(1)=r(1);
...
rOld=r;
d=-MyGrad(r)*(teta)';
t=wolfHim(r,t0,MyGrad,Myfunc,teta);
disp(t)
r=r+t*d;
disp(r)
...
text(1.1,1,'minimum')
title(['Quasi Newton with Wolf Algorithm with' num2str(k) ' iterations']);
%set(gca,'color',[1 1 0])
%set(gcf,'color',[1 0 0])
